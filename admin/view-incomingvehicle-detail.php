...
<head>
    ...
    <title>VPMS - Xem chi tiết xe</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="manage-incomingvehicle.php">Xem xe</a></li>
                                    <li class="active">Xe đến</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Xem xe đến</strong>
                        </div>
                        <div class="card-body">
...
<tr>
   ...
   <select name="status" class="form-control" required="true" >
     <option value="Out">Xe ra</option>
                                 ...
                                 <tr>  <p style="text-align: center;"><td> <button type="submit" class="btn btn-primary btn-sm" name="submit" >Cập nhật</button></p></td></tr>
                                </form>
                            </table>
<?php } else { ?>
    <table border="1" class="table table-bordered mg-b-0">
