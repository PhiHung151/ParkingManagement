...
<head>
    ...
    <title>VPMS - Xem chi tiết bãi đậu xe</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="view-vehicle.php">Xem chi tiết bãi đậu xe</a></li>
                                    <li class="active">Xem chi tiết bãi đậu xe</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Xem chi tiết bãi đậu xe (dựa trên số điện thoại di động đã đăng ký)</strong>
                        </div>
                        <div class="card-body">
                             <table class="table">
                <thead>
...
?>
                ...
                <tr>
                  ...
                  <td><a href="view--detail.php?viewid=<?php echo $row['vehid'];?>" class="btn btn-primary">Xem</a> 

<a href="print.php?vid=<?php echo $row['vehid'];?>" style="cursor:pointer" target="_blank" class="btn btn-warning">In ra</a>
                  </td>
                </tr>
                <?php 
$cnt=$cnt+1;
