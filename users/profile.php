...
<head>
    ...
    <title>VPMS - Hồ sơ người dùng</title>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Hồ sơ </strong> người dùng
                            </div>
...
?> 
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="disabled-input" class=" form-control-label">Ngày đằng ký</label></div>
